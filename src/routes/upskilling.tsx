...
function UpskillingPersonaPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary selection:text-white">
      ...
      <PersonaModal open={modalOpen} onOpenChange={setModalOpen} track="fellowship" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="space-y-6">
              <Badge variant="outline" className="px-3.5 py-1.5 rounded-full border-primary/30 bg-primary/10 text-primary text-xs font-bold gap-2">
                ...
                Executive Fellowship · Part-Time
              </Badge>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.1]">
                Keep Your Practice.{" "}
                <span className="text-primary">Build Your Venture Side.</span>
              </h1>
