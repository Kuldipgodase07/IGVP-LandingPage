  ...
  return (
    <section id="events-section" className="py-24 md:py-32 bg-background relative overflow-hidden border-t border-border/60">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* SEARCH BAR & CATEGORY TABS - Pixel Perfect Responsive Layout */}
        <div className="mb-10 bg-card/90 border border-border/80 p-3 sm:p-4 rounded-2xl shadow-sm backdrop-blur-md">
          <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-4">
            
            {/* Category Pills (Strictly Single Line with no-scrollbar) */}
            <div className="flex items-center gap-2 overflow-x-auto no-scrollbar py-1 px-0.5 scroll-smooth flex-1 min-w-0">
              {[
                ...
                return (
                  <button
                    ...
                    className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold whitespace-nowrap shrink-0 transition-all duration-200 cursor-pointer select-none ${
                      isActive
                        ? "bg-primary text-primary-foreground shadow-md shadow-primary/25 scale-[1.02]"
                        : "bg-surface/80 border border-border/60 text-foreground/80 hover:bg-surface hover:text-foreground"
                    }`}
                  >
            ...
            {/* Search Input & Format Filter (Strictly fit within container with custom dropdown arrow) */}
            <div className="flex items-center gap-2.5 shrink-0 justify-end w-full lg:w-auto">
              <div className="relative flex-1 lg:w-56 xl:w-64">
                ...
                <Input
                  ...
                  className="pl-9 pr-8 h-10 rounded-full text-xs bg-surface/80 border-border/80 focus:border-primary"
                />
                {searchQuery && (
                  <button
              ...
              <div className="relative shrink-0">
                <select
                  ...
                  className="h-10 pl-4 pr-9 rounded-full text-xs font-bold bg-surface/80 border border-border/80 text-foreground focus:ring-1 focus:ring-primary outline-none cursor-pointer appearance-none shrink-0"
                >
